      ...
      {updateAvailable && (
        <>
          ...
          <div className="hidden px-2 py-1.5 md:block">
            <button
              className="group flex w-full items-center gap-2.5 rounded-md px-2.5 py-2 text-left transition-colors hover:bg-accent/60"
          ...
          <div className="px-3 py-2 md:hidden">
            <button
              className="flex h-11 w-full items-center gap-3 rounded-md border border-border bg-card px-3.5 transition-all active:scale-[0.98]"
              onClick={onShowVersionModal}
            >
              <div className="relative flex-shrink-0">
